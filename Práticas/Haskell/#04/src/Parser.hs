...
happyExpList = Happy_Data_Array.listArray (0,65) ([14864,8,0,60,929,16,8,4100,2106,33821,48142,41216,53379,59457,29728,0,0,96,48,0,32815,49175,11,0,0,0,0
	])
...
action_3 (6) = happyShift action_12
...
action_21 (6) = happyShift action_12
...
action_22 (6) = happyShift action_12
...
action_23 (6) = happyShift action_12
action_23 (7) = happyShift action_13
...
happyReduction_1 (HappyTerminal (TOK_NUM happy_var_1))
	 =  HappyAbsSyn4
		 (happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TOK_NUM happy_dollar_dollar -> cont 5;
	TOK_PLUS -> cont 6;
	TOK_MINUS -> cont 7;
	TOK_MULT -> cont 8;
	TOK_DIV -> cont 9;
	TOK_LPAREN -> cont 10;
	TOK_RPAREN -> cont 11;
	TOK_SQRT happy_dollar_dollar -> cont 12;
	TOK_EXP happy_dollar_dollar -> cont 13;
	TOK_LOG happy_dollar_dollar -> cont 14;
	_ -> happyError' ((tk:tks), [])
	}
